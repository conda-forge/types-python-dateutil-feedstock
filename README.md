About types-python-dateutil-feedstock
=====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/types-python-dateutil-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/types-python-dateutil-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add types-python-dateutil
# for installing globally
pixi global install types-python-dateutil
```
...
It is possible to list all of the versions of `types-python-dateutil` available on your platform:
...
```
pixi search types-python-dateutil --channel conda-forge
```
